...
* src/main/java/pl/coderslab/mysql/create
* src/main/java/pl/coderslab/mysql/change
* src/main/java/pl/coderslab/mysql/modification
* src/main/java/pl/coderslab/mysql/onetoone
* src/main/java/pl/coderslab/mysql/onetomany

#### Dzień 2

* src/main/java/pl/coderslab/mysql/manytomany
* src/main/java/pl/coderslab/mysql/javamysql
